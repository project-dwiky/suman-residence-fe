      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white mb-4">SUMAN RESIDENCE</h3>
            <p className="text-slate-300 text-sm">
              Hunian eksklusif dengan fasilitas premium dan lokasi strategis yang dirancang untuk kehidupan yang nyaman dan berkualitas.
            </p>
            <div className="flex items-start text-sm pt-2">
              <MapPin size={18} className="mr-2 text-primary flex-shrink-0 mt-0.5" />
              <span className="flex-1">Jl. Kayee Adang Utama, Lamgugob, Kec. Syiah Kuala, Kota Banda Aceh, Aceh 23115</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center text-sm">
              ...
              <a href="mailto:Sumanresidence338@gmail.com" className="hover:text-primary transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 mb-6">
              <a href="https://www.instagram.com/Suman_Residence" target="_blank" rel="noopener noreferrer" 
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://www.tiktok.com/@Suman.Residence" target="_blank" rel="noopener noreferrer" 
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link href="/kamar" className="hover:text-primary transition-colors">Kamar</Link>
                </li>
                <li>
                  <Link href="/fasilitas" className="hover:text-primary transition-colors">Fasilitas</Link>
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* Copyright */}
        <div className="py-6 text-center border-t border-slate-800 text-sm text-slate-400">
          <p>© {currentYear} Suman Residence. All rights reserved.</p>
          <p className="mt-1">Designed with ❤️ for premium living experience.</p>
        </div>
      </div>
    </footer>
  );
