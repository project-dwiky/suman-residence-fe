...
const HeroSection = () => {
    // Hero image
    const heroImage = "/suman.jpg";

    return (
        <section
            className="py-6 md:py-16 bg-background relative overflow-hidden"
            id="hero-section"
        >
                    ...
                    <div className="md:col-span-2 flex flex-col z-10">
                        ...
                        >
                            ...
                            >
                                <Button
                                    size="lg"
                                    className="bg-primary text-white hover:bg-primary/90 rounded-full w-fit mb-3 transition-all duration-300 hover:shadow-md"
                                >
                                    Booking Sekarang
                                </Button>
                            </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-[10px] md:text-xs text-muted-foreground leading-tight max-w-[90px] mx-auto">
                                            Unit kamar tersedia untuk pilihan
                                            Anda
                                        </p>
                                    </motion.div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-[10px] md:text-xs text-muted-foreground leading-tight max-w-[90px] mx-auto">
                                            Fasilitas modern untuk kenyamanan
                                            optimal
                                        </p>
                                    </motion.div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-[10px] md:text-xs text-muted-foreground leading-tight max-w-[90px] mx-auto">
                                            Dari 22 pengguna di Google Maps
                                        </p>
                                    </motion.div>
                                </motion.div>
                            </motion.div>
